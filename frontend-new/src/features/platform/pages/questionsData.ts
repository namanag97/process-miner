...
export interface ProcessQuestion {
  ...
  title: string;
  description: string;
  route?: (projectId: string, datasetId: string) => string;
  action?: 'feedback';
}
...
export const PROCESS_QUESTIONS: ProcessQuestion[] = [
  {
    ...
    route: (projectId, datasetId) => `/workspace/${projectId}/data/${datasetId}/explorer`,
  },
  {
    id: 'duration',
    ...
    route: (projectId, datasetId) => `/workspace/${projectId}/data/${datasetId}/kpi?tab=performance`,
  },
  {
    id: 'deadlines',
    ...
    route: (projectId, datasetId) => `/workspace/${projectId}/data/${datasetId}/kpi?tab=deadlines`,
  },
  {
    id: 'unwanted',
    ...
    route: (projectId, datasetId) => `/workspace/${projectId}/data/${datasetId}/kpi?tab=unwanted`,
  },
  {
    id: 'automation',
    icon: RobotOutlined,
    ...
    route: (projectId, datasetId) => `/workspace/${projectId}/data/${datasetId}/kpi?tab=automation`,
  },
  {
    id: 'custom',
    icon: BulbOutlined,
