    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        <h1 className={styles.heroTitle}>
          ...
          <span className={styles.heroHighlight}>Process Miner</span>
        </h1>
        ...
        <p className={styles.heroNote}>
          No credit card required. Upload up to 100MB free.
        </p>
      </div>
...
function FAQSection() {
  ...
  return (
    ...
    >
      ...
      <p className={styles.sectionSubtitle}>
        Common questions about Process Miner
      </p>
...
function CTASection() {
  ...
  return (
    ...
    >
      ...
      <p className={styles.ctaSubtitle}>Start free. No credit card required. Upload up to 100MB.</p>
      <Link to="/workspace" className={`${styles.btnPrimary} ${styles.btnLarge}`}>
        Start Your Free Trial
      </Link>
      <p className={styles.ctaNote}>
        Join 500+ companies already optimizing their processes
      </p>
    </section>
  );
}
    ...
    <footer className={styles.footer}>
      <div className={styles.footerInner}>
        <span className={styles.footerCopyright}>
          © 2024 Process Miner. All rights reserved.
        </span>
