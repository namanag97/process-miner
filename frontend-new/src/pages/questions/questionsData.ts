...
export const PROCESS_QUESTIONS: ProcessQuestion[] = [
  {
    ...
    route: (projectId, logId) => `/projects/${projectId}/data/${logId}/explorer`,
  },
  {
    id: 'duration',
    ...
    route: (projectId, logId) => `/projects/${projectId}/data/${logId}/kpi?tab=performance`,
  },
  {
    id: 'deadlines',
    ...
    route: (projectId, logId) => `/projects/${projectId}/data/${logId}/kpi?tab=deadlines`,
  },
  {
    id: 'unwanted',
    ...
    route: (projectId, logId) => `/projects/${projectId}/data/${logId}/kpi?tab=unwanted`,
  },
  {
    id: 'automation',
    icon: RobotOutlined,
    ...
    route: (projectId, logId) => `/projects/${projectId}/data/${logId}/kpi?tab=automation`,
  },
  {
    id: 'custom',
    icon: BulbOutlined,
