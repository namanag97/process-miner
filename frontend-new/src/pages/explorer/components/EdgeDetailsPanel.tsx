...
import { Typography, Descriptions, Tag, Button, Space, Divider, Progress, Tooltip } from 'antd';
import {
  FilterOutlined,
  CloseOutlined,
  SwapRightOutlined,
...
export interface EdgeDetail {
  ...
  probability?: number;  // Probability of taking this path from source
}
...
export function EdgeDetailsPanel({
  ...
  // Calculate performance color if duration available
  const performanceColor =
    avgDurationSeconds !== undefined && minDurationSeconds !== undefined && maxDurationSeconds !== undefined
      ? getPerformanceColor(avgDurationSeconds, minDurationSeconds, maxDurationSeconds)
      : undefined;
  ...
  return (
    <div style={{ padding: tokens.spacing[4] }}>
      ...
      <TransitionVisual source={source} target={target} probability={probability} />
      ...
      <Descriptions column={1} size="small" style={{ marginBottom: tokens.spacing[4] }}>
        ...
        {probability !== undefined && (
          ...
          >
            <Text strong>{(probability * 100).toFixed(1)}%</Text>
        ...
        {avgDurationSeconds !== undefined && (
          ...
          >
            <Tag color={performanceColor ? undefined : 'default'} style={{ backgroundColor: performanceColor ? `${performanceColor}20` : undefined, color: performanceColor, borderColor: performanceColor }}>
