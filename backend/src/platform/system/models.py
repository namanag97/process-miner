...
class FeatureFlag(Base):
    ...
    enabled_for_orgs_json: Mapped[str | None] = mapped_column(Text, nullable=True)  # ["org_id_1", ...]
    enabled_for_users_json: Mapped[str | None] = mapped_column(Text, nullable=True)  # ["user_id_1", ...]
...
class APIUsage(Base):
    ...
    __table_args__ = (
        Index("ix_api_usage_org_period", "org_id", "period_start", "period_end"),
    )
