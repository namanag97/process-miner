...
class Workflow(Base):
    ...
    entity_type: Mapped[str | None] = mapped_column(String(50), nullable=True)  # 'dataset', 'model', 'analysis'
...
class WorkflowTask(Base):
    ...
    # Error details
    error_message: Mapped[str | None] = mapped_column(Text, nullable=True)
    error_details_json: Mapped[str | None] = mapped_column(Text, nullable=True)  # Stack trace, context
    ...
    __table_args__ = (
        Index("ix_workflow_tasks_order", "workflow_id", "task_order"),
    )
