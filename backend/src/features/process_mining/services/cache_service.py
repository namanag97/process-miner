...
from src.features.process_mining.models import DFGCache, Dataset, VariantCache
...
class CacheService:
        ...
        if not force_recompute:
            ...
            if cached:
                ...
                return {
                    ...
                    "activity_counts": json.loads(cached.activity_counts) if cached.activity_counts else None,
    ...
    async def _compute_variants(self, dataset_id: str) -> dict[str, Any]:
        ...
        avg_length = sum(len(v["sequence"]) * v["count"] for v in variant_list) / total_cases if total_cases > 0 else 0
    ...
    async def _store_dfg_cache(
        ...
        cache_entry = DFGCache(
            ...
            activity_counts=json.dumps(dfg_data.get("activity_counts")) if dfg_data.get("activity_counts") else None,
