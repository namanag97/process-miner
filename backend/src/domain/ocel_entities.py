...
class ObjectInstance:
    ...
    def create(cls, object_type: str, object_id: str, **attributes) -> "ObjectInstance":
        ...
        return cls(id=uuid4(), object_type=object_type, object_id=object_id, attributes=attributes)
...
class ObjectRelationship:
    ...
    @classmethod
    def create(
        cls, source_object_id: str, target_object_id: str, relationship_type: str
    ) -> "ObjectRelationship":
...
class ObjectCentricEventLog:
    ...
    @classmethod
    def create(
        cls, name: str, source_file: Optional[str] = None, source_format: str = "jsonocel"
    ) -> "ObjectCentricEventLog":
        """Factory method to create an ObjectCentricEventLog."""
        return cls(id=uuid4(), name=name, source_file=source_file, source_format=source_format)
