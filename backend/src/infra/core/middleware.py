...
from src.infra.core.logging_config import bind_context, clear_context, get_logger
...
class RequestLoggingMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        ...
        if should_log_to_devconsole:
            try:
                from src.infra.devconsole import log_api_request
        ...
        try:
            ...
            if should_log_to_devconsole:
                try:
                    from src.infra.devconsole import log_api_response
            ...
            try:
                from src.infra.devconsole import log_error
