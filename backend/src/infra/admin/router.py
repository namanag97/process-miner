...
from src.infra.core.exceptions import AuthorizationError, NotFoundError
from src.infra.core.logging_config import get_logger
from src.infra.users import Organization, User, Workspace
...
async def get_system_stats(
    ...
    from src.infra.health.router import get_uptime
