...
from src.infra.core.exceptions import ConflictError
from src.infra.core.logging_config import get_logger
from src.infra.core.permissions import Permission
from src.infra.core.validation import (
...
from src.infra.users import Project, Workspace, WorkspaceMember
...
async def add_file_to_project(
    ...
    """
    from src.infra.workspaces.authorization import (
