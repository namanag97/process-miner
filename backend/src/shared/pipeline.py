...
class Pipeline:
    ...
    async def execute(
        ...
        logger.info(f"pipeline_start", name=self.name, nodes=execution_order)
        ...
        for node_id in execution_order:
            ...
            if cache_key in self.cache:
                logger.info(f"cache_hit", node=node_id)
            ...
            try:
                ...
                logger.info(f"node_complete", node=node_id, duration_ms=duration)
                ...
                logger.error(f"node_failed", node=node_id, error=str(e))
