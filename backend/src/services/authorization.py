...
if TYPE_CHECKING:
    from src.models.orm import User, Workspace, WorkspaceMember
...
class AuthorizationService:
    ...
    async def get_workspace_membership(
        ...
        """
        from src.models.orm import WorkspaceMember
...
async def require_model_permission(
    ...
    Raises:
        ...
        ForbiddenError: If user lacks permission
    """
    from src.models.orm import Dataset, ProcessModel, Project
