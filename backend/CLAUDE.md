...
**Core Structure:**
- `src/api/routers/` - 11 FastAPI routers
- `src/services/` - 11 PM4Py wrapper services (1:1 with routers)
- `src/models/orm.py` - 10 SQLAlchemy tables (async)
...
**11 Routers:**
processes, discovery, visualization, conformance, ocpm, workflows, analytics, filtering, organizational, predictions, simulation

**DB Tables:**
event_logs, process_cases, process_events, process_models, conformance_results, workflows, workflow_runs, ocel_logs, ocel_object_types, oc_petri_nets
