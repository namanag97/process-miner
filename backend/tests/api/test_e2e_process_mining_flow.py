...
async def test_complete_process_mining_flow(client: AsyncClient, sample_csv_bytes, db_session):
    ...
    # Bottlenecks
    bottlenecks_response = await client.get(f"/api/v1/analytics/datasets/{dataset_id}/bottlenecks")
    ...
    # Cycle time
    cycle_time_response = await client.get(f"/api/v1/analytics/datasets/{dataset_id}/cycle-time")
