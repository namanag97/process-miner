...
class TestFilterApplication:
    ...
    @pytest.mark.asyncio
    async def test_apply_time_range_filter(self, client: AsyncClient, uploaded_insurance_log_id: str):
    ...
    @pytest.mark.asyncio
    async def test_filter_reduces_case_count(self, client: AsyncClient, uploaded_insurance_log_id: str):
        """Verify filtering reduces case count."""
        # Get original stats
        original_resp = await client.get(f"/api/v1/processes/{uploaded_insurance_log_id}/statistics")
