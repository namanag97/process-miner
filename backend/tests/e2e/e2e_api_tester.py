...
from helpers.openapi_parser import OpenAPIParser, APIEndpoint
...
class E2EAPITester:
    ...
    def _run_tests(self) -> None:
        ...
        endpoints_to_test = [
            ep for ep in self.parser.endpoints
    ...
    def _test_endpoint(self, endpoint: APIEndpoint) -> None:
        ...
        if path_params:
            ...
            print(f"  ⊘ {endpoint.method.value:6s} {endpoint.path:50s} [SKIPPED - requires path params]")
            return
        ...
        print(f"  {status_symbol} {endpoint.method.value:6s} {endpoint.path:50s} {status_str:3s} {response_time_ms:6.0f}ms{bug_indicator}")
